...
if (typeof gemius_hcconn == "undefined") {
	gemius_hcconn = {
		...
		latehits : function() {
			...
			if ((gemius_hcconn.has_consent === false || (gemius_hcconn.waiting_for_fpdata==0 && gemius_hcconn.waiting_for_lsdata==0)) && gemius_hcconn.waiting_on_prerender==0 && gemius_hcconn.waiting_for_chints == 0) {
		...
		findchints : function() {
			if (typeof navigator.userAgentData == 'object' && typeof navigator.userAgentData.getHighEntropyValues == 'function') {
				try {
					...
					setTimeout(gemius_hcconn.chints_failed,10000);
				} catch(e) {
